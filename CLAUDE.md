...
- Fase 2 iniciada no `agent`:
  ...
  - `process_narrative_tick` agora delega ingestao de incidentes/correlacao para `narrative_incident_ingest`
  - `process_narrative_tick` agora delega geracao de summary/digest para `narrative_daily_summary`
